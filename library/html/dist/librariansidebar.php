    ...
    <div id="sidebar-collapse">
        <div class="admin-block d-flex">
            <div>
                ...
                <?php } else {
                ?>
                    <img class="img-circle" src="librarianimage/<?php echo $rowlibrarian['librarianimage']; ?>" width="45px" />
                <?php
                }
                ?>
            </div>
            <div class="admin-info">
                <div class="font-strong"><?php echo $rowlibrarian['firstname']; ?> <?php echo $rowlibrarian['lastname']; ?></div><small>Librarian</small>
            </div>
        </div>
        <ul class="side-menu metismenu">
            <li>
                <a class="active" href="librariandashboard.php"><i class="sidebar-item-icon fa fa-th-large"></i>
            ...
            <li>
                <a href="javascript:;"><i class="sidebar-item-icon fa fa-address-book-o"></i>
                    <span class="nav-label">Book Issue Request</span><i class="fa fa-angle-left arrow"></i></a>
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="bookissue.php">Book Issue Confirmation</a>
                    </li>

                </ul>
            </li>
            <li>
                <a href="javascript:;"><i class="sidebar-item-icon fa fa-minus-circle"></i>
                    <span class="nav-label">Book Return</span><i class="fa fa-angle-left arrow"></i></a>
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="bookreturn.php">Book Return Confirmation</a>
                    </li>
            ...
            <li>
                <a href="javascript:;"><i class="sidebar-item-icon fa fa-money"></i>
                    <span class="nav-label">Fine</span><i class="fa fa-angle-left arrow"></i></a>
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="fine.php">Late Fine</a>
                    </li>
                    <li>
                        <a href="latebookreturnfinechartlib.php">Fine Chart</a>
                    </li>
