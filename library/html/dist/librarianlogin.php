...
<body class="bg-silver-300">
    <div class="content">
        <div class="brand">
            <a class="link" href="librarianlogin.php">Librarian</a>
        </div>
    ...
    if (isset($_POST["login"])) {
        ...
        $abd = "select *from librariandetails where email='$email' and password='$password'";
        ...
        if ($rc == 1) {
            ...
            echo "<script>alert('$message');window.location.href='librariandashboard.php';</script>";
        } else {
            $message1 = "Login UnSucessfull";
            echo "<script>alert('$message1');window.location.href='librarianlogin.php';</script>";
        }
    }
    ?>
