...
<head>
    ...
    <title>Student Details Approve</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Student Details Approval</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">All Not Approved Student Details Here</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $qstudent = "select * from student where approvestatus = 'NA'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="approvestudent.php?studentapprove=<?php echo $rowstudent['slno']; ?>" onclick="return confirm('Do You Want To Approve The Student Details')" ;>Approve</a></td>
                                        <td><a href="deletestudent.php?student=<?php echo $rowstudent['slno']; ?>" onclick="return confirm('Do You Want Delete Student Details')" ;>Delete</a></td>
                                    </tr>
                                <?php
                                    $c++;
                                }
