...
<header class="header">
    <div class="page-brand">
        <a class="link" href="studentdashboard.php">
    ...
    <div class="flexbox flex-1">
        ...
        <ul class="nav navbar-toolbar">
            ...
            <li class="dropdown dropdown-user">
                ...
                ?>
                    <span></span><?php echo $rowstudent['firstname'];  ?> <?php echo $rowstudent['lastname'];  ?><i class="fa fa-angle-down m-l-5"></i></a>
                <ul class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="studentprofile.php"><i class="fa fa-user"></i>Profile</a>
                    <!-- <a class="dropdown-item" href="profile.html"><i class="fa fa-cog"></i>Settings</a>
                    <a class="dropdown-item" href="javascript:;"><i class="fa fa-support"></i>Support</a> -->
                    
                    <a class="dropdown-item" href="studentchangepassword.php"><i class="fa fa-cog"></i>Change Password</a>
                    <li class="dropdown-divider"></li>
                    <a class="dropdown-item" href="studentlogin.php"><i class="fa fa-power-off"></i>Logout</a>
                </ul>
            </li>
        </ul>
