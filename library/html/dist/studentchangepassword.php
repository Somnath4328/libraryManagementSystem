...
<head>
    ...
    <script type="text/javascript">
        function check(student) {
            var password = student.newpassword.value;
            var confirmpassword = student.confirmpassword.value;
            if (password != confirmpassword) {
                alert("Password does not match !!!");
                student.confirmpassword.focus();
                return false;
            }
            return true;
        }
...
<body class="fixed-navbar sidebar-mini">
                        ...
                        <div class="ibox">
                            <div class="ibox-body text-center">
                                <div class="m-t-20">
                                    ...
                                    <img class="img-circle" src="studentimage/<?php echo $rowstudent['studentimage']; ?>" />


                                </div>
                                <h5 class="font-strong m-b-10 m-t-10"><?php echo $rowstudent['firstname'] ?> <?php echo $rowstudent['lastname'] ?></h5>
                                <div class="m-b-20 text-muted"><?php echo $rowstudent['studentcourse'] ?> <?php echo $rowstudent['studentsemester'] ?></div>
                            ...
                            <div class="ibox-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="tab-2">
                                        <form role="form" name="student" method="POST" onSubmit="return check(student)" enctype="multipart/form-data">
    ...
    if (isset($_POST['changepassword'])) {
        ...
        $check = "select * from student where studentemail='$studentemail' and password='$oldpassword'";
        $res = mysqli_query($conn, $check);
        $rc = mysqli_num_rows($res);
        if ($rc == 1) {
            $qchange = "UPDATE student set password='$newpassword' where studentemail='$studentemail'";
            if (mysqli_query($conn, $qchange)) {
                echo "<script>alert('Password Changed Successfully');window.location.href='studentchangepassword.php';</script>";
            } else {
                echo "<script>alert('Password Not Changed');window.location.href='studentchangepassword.php';</script>";
            }
        }
    }
    ?>
