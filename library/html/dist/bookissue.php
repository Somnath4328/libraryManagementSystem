...
<head>
    ...
    <title>Book Issue Request</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Book Issue Request</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Students Book Issue Request Details</div>
                            ...
                            <div class="ibox-body">
                                ...
                                <div style="overflow-x:auto;">
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $qbooking = "select *from booking where status = 'Booked'";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="bookissueconfirm.php?bic=<?php echo $rowbooking['bookingno']; ?>" onclick="return confirm('Do You Want To Confirm')" ;>Confirm</a></td>
                                                </tr>
                                            <?php
                                                $c++;
                                            }
