...
<header class="header">
    <div class="page-brand">
        <a class="link" href="librariandashboard.php">
            <span class="brand">GodLike&nbsp
                <span class="brand-tip">Library</span>
            </span>
        ...
        <ul class="nav navbar-toolbar">
            ...
            <li class="dropdown dropdown-user">
                <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                    ...
                    ?>
                    <span></span><?php echo $rowlibrarian['firstname']; ?> <?php echo $rowlibrarian['lastname']; ?><i class="fa fa-angle-down m-l-5"></i></a>
                <ul class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="librarianprofile.php"><i class="fa fa-user"></i>Profile</a>
                    <a class="dropdown-item" href="librarianchangepassword.php"><i class="fa fa-cog"></i>ChangePassword</a>
                        <!-- <a class="dropdown-item" href="javascript:;"><i class="fa fa-support"></i>Support</a> -->
                        <li class="dropdown-divider"></li>
                    <a class="dropdown-item" href="librarianlogin.php"><i class="fa fa-power-off"></i>Logout</a>
                </ul>
            </li>
        </ul>
