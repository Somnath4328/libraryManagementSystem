...
$qadmin = "select * from admin where email='$adminemail'";
...
<head>
    ...
    <title><?php echo $rowadmin['firstname']; ?>'s | Profile</title>
...
<body class="fixed-navbar sidebar-mini">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title"><?php echo $rowadmin['firstname'] ?> <?php echo $rowadmin['lastname'] ?></h1>
                <ol class="breadcrumb">
                        ...
                        <div class="ibox">
                            <div class="ibox-body text-center">
                                <div class="m-t-20">
                                    ...
                                    <?php } else {
                                    ?>
                                        <img class="img-circle" src="adminimage/<?php echo $rowadmin['adminimage']; ?>" width="150px" />
                                    <?php
                                    }
                                    ?>
                                </div>
                                <h5 class="font-strong m-b-10 m-t-10"><?php echo $rowadmin['firstname'] ?> <?php echo $rowadmin['lastname'] ?></h5>
                                <div class="m-b-20 text-muted">Admin</div>
                                        ...
                                        <form action="javascript:void(0)">
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <input class="form-control" name="firstname" type="text" placeholder="First Name" value="<?php echo $rowadmin['firstname'] ?>" readonly>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label>Last Name</label>
                                                    <input class="form-control" name="lastname" type="text" placeholder="First Name" value="<?php echo $rowadmin['lastname'] ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <label>Email</label>
                                                    <input class="form-control" type="text" name="email" placeholder="Email address" value="<?php echo $rowadmin['email'] ?>" readonly>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label>Phone Number</label>
                                                    <input class="form-control" type="" name="phonenumber" placeholder="Phonenumber" pattern="[0-9]{10}" title="Please Enter 10 digit Phone Number" value="<?php echo $rowadmin['phonenumber'] ?>" readonly>
                                                </div>
                                            </div>
    ...
    if (isset($_POST["upload"])) {
        ...
        $uploadimage = "UPDATE admin set adminimage = '$image_name' where email='$adminemail'";
        if (mysqli_query($conn, $uploadimage)) {
            echo "<script>alert('Your Image Uploaded Successfully');window.location.href='adminprofile.php';</script>";
        } else {
            echo "<script>alert('Your Image Not Uploaded');window.location.href='adminprofile.php';</script>";
        }
    }
    ?>
</body>
