...
<body class="bg-silver-300">
    <div class="content">
        <div class="brand">
            <a class="link" href="adminlogin.php">Admin</a>
        </div>
        <form role="form" name="form" method="POST">
            ...
            <div class="form-group">
                <div class="input-group-icon right">
                    ...
                    <input class="form-control"  name="email" type="email" placeholder="Email" title="Enter Valid Email" value="<?php if (isset($_COOKIE["email"])) {
                                                                                                                                echo $_COOKIE["email"];
                                                                                                                            } ?>" required>
                </div>
            </div>
