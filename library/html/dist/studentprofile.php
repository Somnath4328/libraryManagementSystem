...
<head>
    ...
    <title><?php echo $rowstudent['firstname']; ?>'s | Profile</title>
    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title"><?php echo $rowstudent['firstname'] ?> <?php echo $rowstudent['lastname'] ?></h1>
                <ol class="breadcrumb">
                        ...
                        <div class="ibox">
                            <div class="ibox-body text-center">
                                <div class="m-t-20">
                                    ...
                                    <?php } else {
                                    ?>
                                        <img class="img-circle" src="studentimage/<?php echo $rowstudent['studentimage']; ?>" width="150px" />
                                    <?php
                                    }
                                    ?>
                                </div>
                                <h5 class="font-strong m-b-10 m-t-10"><?php echo $rowstudent['firstname'] ?> <?php echo $rowstudent['lastname'] ?></h5>
                                <div class="m-b-20 text-muted"><?php echo $rowstudent['studentcourse'] ?>(<?php echo $rowstudent['studentdepartment'] ?>)  <?php echo $rowstudent['studentsemester'] ?></div>
                                        ...
                                        <form action="javascript:void(0)">
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <input class="form-control" name="firstname" type="text" placeholder="First Name" value="<?php echo $rowstudent['firstname'] ?>" readonly>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label>Last Name</label>
                                                    <input class="form-control" name="lastname" type="text" placeholder="First Name" value="<?php echo $rowstudent['lastname'] ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <label>Course</label>
                                                    <input class="form-control" name="coursename" type="text" placeholder="Course Name" value="<?php echo $rowstudent['studentcourse'] ?>" readonly>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label>Department</label>
                                                    <input class="form-control" name="departmentname" type="text" placeholder="Department Name" value="<?php echo $rowstudent['studentdepartment'] ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <label>Roll No.</label>
                                                    <input class="form-control" name="rollno" type="number" placeholder="Roll Number" value="<?php echo $rowstudent['studentroll'] ?>" readonly>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label>Semester</label>
                                                    <input class="form-control" name="semester" type="text" placeholder="Student Semester" value="<?php echo $rowstudent['studentsemester'] ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    <label>Email</label>
                                                    <input class="form-control" type="text" name="email" placeholder="Email address" value="<?php echo $rowstudent['studentemail'] ?>" readonly>
                                                </div>
                                                <div class="col-sm-6 form-group">
                                                    <label>Phone Number</label>
                                                    <input class="form-control" type="" name="phonenumber" placeholder="Phonenumber" pattern="[0-9]{10}" title="Please Enter 10 digit Phone Number" value="<?php echo $rowstudent['studentphonenumber'] ?>" readonly>
                                                </div>
                                            </div>
    ...
    if (isset($_POST["upload"])) {
        ...
        if ($image) {
            ...
            if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") &&  ($extension != "gif") && ($extension != "bmp") && ($extension != "pdf")) {
                ...
                $newname = "studentimage/" . $image_name;
        ...
        $uploadimage = "UPDATE student set studentimage = '$image_name' where studentemail='$studentemail'";
        if (mysqli_query($conn, $uploadimage)) {
            echo "<script>alert('Student Image Uploaded Successfully');window.location.href='studentprofile.php';</script>";
        } else {
            echo "<script>alert('Student Image Not Uploaded');window.location.href='studentprofile.php';</script>";
        }
    }
    ?>
