...
<body class="fixed-navbar sidebar-mini">
                        ...
                        <div class="ibox">
                            <div class="ibox-body text-center">
                                <div class="m-t-20">
                                    ...
                                    <img class="img-circle" src="adminimage/<?php echo $rowadmin['adminimage']; ?>" />
    ...
    if (isset($_POST['changepassword'])) {
        ...
        $check = "select * from admin where email='$adminemail' and password='$oldpassword'";
        $res = mysqli_query($conn, $check);
        $rc = mysqli_num_rows($res);
        if ($rc == 1) {
            $qchange = "UPDATE admin set password='$newpassword',confirmpassword='$newpassword' where email='$adminemail'";
            if (mysqli_query($conn, $qchange)) {
                echo "<script>alert('Password Changed Successfully');window.location.href='adminchangepassword.php';</script>";
            } else {
                echo "<script>alert('Password Not Changed');window.location.href='adminchangepassword.php';</script>";
            }
        }
        else
        {
            echo "<script>alert('Old Password Does Not Match');window.location.href='adminchangepassword.php';</script>";
        }
    }
    ?>
</body>
