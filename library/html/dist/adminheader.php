...
<header class="header">
    <div class="page-brand">
        <a class="link" href="admindashboard.php">
        ...
        <ul class="nav navbar-toolbar">
            ...
            <li class="dropdown dropdown-user">
                <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                    ...
                    ?>
                    <span></span><?php echo $rowadmin['firstname']; ?> <?php echo $rowadmin['lastname']; ?><i class="fa fa-angle-down m-l-5"></i></a>
                <ul class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="adminprofile.php"><i class="fa fa-user"></i>Profile</a>
                    <a class="dropdown-item" href="adminchangepassword.php"><i class="fa fa-cog"></i>Change Password</a>
